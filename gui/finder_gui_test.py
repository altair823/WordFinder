...
# Form implementation generated from reading ui file 'finder_gui_test.ui'
#
...
"border-color: rgb(255, 255, 255);")
        ...
        self.naver_web = QtWebEngineWidgets.QWebEngineView(self.scrollAreaWidgetContents_4)
        self.naver_web.setUrl(QtCore.QUrl("about:blank"))
        self.naver_web.setObjectName("naver_web")
        self.verticalLayout_2.addWidget(self.naver_web)
        ...
        self.wiki_web = QtWebEngineWidgets.QWebEngineView(self.scrollAreaWidgetContents_5)
        self.wiki_web.setUrl(QtCore.QUrl("about:blank"))
        self.wiki_web.setObjectName("wiki_web")
        self.verticalLayout_3.addWidget(self.wiki_web)
